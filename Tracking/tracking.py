...
class Tracker:
    ...
    def track(self, new_frame, old_position):
        ...
        if self.points is not None:
            new_points, self.status, self.err = cv2.calcOpticalFlowPyrLK(old_position.frame, new_frame, self.points, None, **self.lk_params)
            pointsFB, statusFB, self.FB_error = cv2.calcOpticalFlowPyrLK(new_frame, old_position.frame, new_points, None,
                                                                     **self.lk_params)
            i = 0
